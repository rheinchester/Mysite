...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="ResponsiveNav.css">
...
<nav class="navbar navbar-inverse">
    ...
    <a class="navbar-brand" href="#">The Rounder</a>
  </div>
...
<!-- Figure out if it's good practice to use bootstrap link or your own link....What are the advantages -->
<!-- what does metaname do -->